"""
This module defines data models for conditional entry point flow parameters and configurable conditional entry points using Pydantic for validation.
It includes models for conditional entry point flow parameters and configurable conditional entry points, ensuring that certain constraints are met.

Classes:
    KConditionalEntryPointFlowParam_v1: Represents the flow parameters for a conditional entry point.
    KConfigurableConditionalEntryPoint_v1: Represents a configurable conditional entry point in a graph.
